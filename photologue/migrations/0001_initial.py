# Generated by Django 2.1.8 on 2019-05-28 15:04
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('search', 'search'), ('basket', 'basket'), ('ready', 'ready')], max_length=20, verbose_name='status')),
        ...
        migrations.AlterUniqueTogether(
            name='eventphoto',
            unique_together={('event', 'database_photo'), ('event', 'slug')},
        ),
        migrations.AlterUniqueTogether(
            name='eventbasketchosenphoto',
        ...
        migrations.AlterUniqueTogether(
            name='databasephoto',
            unique_together={('database', 'slug'), ('database', 'name')},
        ),
        migrations.AlterUniqueTogether(
            name='cbirindex',
