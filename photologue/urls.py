...
urlpatterns = [
    ...
    path('index/info/', views.database_index_info_view, name='database_index_info'),
    ...
    # parameter ?database=slug
    path('index/create/', views.database_index_create_view, name='database_index_create'),

    # Info about concrete index: which database, how many objects indexed,
    # list of events which used this index...
    path('index/<slug:slug>/', views.database_index_detail_view, name='database_index_detail'),
    ...
    path('database/<slug:database_slug>/photo/<int:pk>/', views.database_photo_detail_view, name='database_photo_detail'),
    path('event/<slug:event_slug>/photo/<int:pk>/', views.event_photo_detail_view, name='event_photo_detail'),
