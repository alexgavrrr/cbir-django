...
class CBIRCore:
    ...
    def compute_descriptors(self,
        ...
        :param purpose: one of ['to_index', 'for_training', 'both']
        """
        purpose_options = ['to_index', 'for_training', 'both']
        if purpose not in purpose_options:
            raise ValueError(f'Purpose for computing descriptors must be one of {purpose_options}')
    ...
    def train_clusterer(self,
        ...
        def batch_generator(list_paths_to_images, batch_size):
            pass
