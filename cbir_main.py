...
def create_parser():
    ...
    create_index_parser.add_argument('path_to_1_images')
    create_index_parser.add_argument('path_to_2_images')
    create_index_parser.add_argument('--path_to_distractor_images', required=False, default=None)
    create_index_parser.add_argument('--max_images', type=int, required=False, default=None)
